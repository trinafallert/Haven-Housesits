  ...
  return (
    <div className="space-y-5">
      ...
      <div className="relative flex items-center gap-3">
        ...
        <span className="text-xs text-haven-gray-light font-medium">or sign in with email</span>
        <div className="flex-1 h-px bg-haven-sand" />
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="flex justify-end">
          <Link href="/forgot-password" className="text-xs text-haven-teal hover:text-haven-teal-dark font-medium transition-colors">
            Forgot password?
          </Link>
        </div>
